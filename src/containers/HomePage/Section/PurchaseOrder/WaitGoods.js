...
class WaitGoods extends Component {
  constructor(props) {
    super(props);
    this.state = {
      arrItemDetail: [],
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(WaitGoods)
);
